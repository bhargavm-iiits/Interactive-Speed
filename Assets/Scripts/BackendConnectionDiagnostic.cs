...
public class BackendConnectionDiagnostic : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (connector == null)
        {
            Debug.LogError("VRBackendConnector not found in scene!");
            return;
        }
...
public class QuickConnectionTest : MonoBehaviour
{
    ...
    private IEnumerator RunTests()
    {
        ...
        var connector = FindObjectOfType<VRBackendConnector>();
        
        if (connector == null)
        {
            Debug.LogError("❌ VRBackendConnector not found!");
            yield break;
        }
...
public class ConnectionStatusLogger : MonoBehaviour
{
    ...
    private VRBackendConnector.OnResponseReceived LogEvent(string eventName)
    {
        return (response) =>
        {
